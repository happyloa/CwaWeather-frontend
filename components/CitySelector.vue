<template>
  <div class="flex justify-center items-center w-full">
    <div
      class="inline-flex gap-2 p-2 bg-gray-100 dark:bg-gray-900 rounded-full shadow-lg flex-wrap justify-center">
      <button
        v-for="city in cities"
        :key="city.id"
        @click="selectCity(city.id)"
        class="px-6 py-2 rounded-full font-medium transition-smooth text-sm md:text-base"
        :class="[
